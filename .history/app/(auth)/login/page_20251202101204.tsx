      ...
      <div className="relative z-10 grid min-h-screen grid-cols-1 lg:grid-cols-2">
        ...
        <section className="flex items-center justify-center p-6 sm:p-10">
          <form
            ...
            className="w-full max-w-md space-y-6 rounded-3xl border border-white/10 bg-white/5 p-8 shadow-2xl backdrop-blur"
          >
            ...
            <label className="flex flex-col text-sm font-medium text-slate-200">
              ...
              <input
                ...
                className="mt-2 rounded-2xl border border-white/10 bg-slate-900/60 px-4 py-3 text-white placeholder:text-white/40 focus:border-indigo-400 focus:outline-none"
            ...
            {error && (
              <p className="rounded-2xl border border-red-400/40 bg-red-500/10 px-4 py-3 text-sm text-red-100" role="alert">
                {error}
              </p>
            )}
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full rounded-2xl bg-white px-5 py-3 text-sm font-semibold text-slate-900 shadow-lg shadow-indigo-500/30 transition hover:-translate-y-0.5 disabled:opacity-50"
            >
