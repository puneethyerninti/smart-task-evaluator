...
export async function POST(request: Request) {
  ...
  try {
    ...
    // Request only the `id` column to keep the response small and ensure typing
    ...
    if (error) throw error;
    // `data` can be typed as unknown by the Supabase client. Cast safely before mapping.
    const unlockedIds = Array.isArray(data)
